...
docker exec $(docker ps -q -f name=kafka | tail -n1) /opt/kafka/bin/kafka-topics.sh --create --if-not-exists --zookeeper zookeeper:2181 --partitions 10 --replication-factor 1 --topic load_cars
